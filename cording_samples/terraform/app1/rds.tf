...
# RDS subnet group
#-------------------------
resource "aws_db_subnet_group" "mysql-standalone-subnetgroup" {
...
resource "aws_db_instance" "mysql_standalone" {
  ...
  username = "admin"
  password = random_string.db_pw.result
  ...
  db_subnet_group_name   = aws_db_subnet_group.mysql-standalone-subnetgroup.name
